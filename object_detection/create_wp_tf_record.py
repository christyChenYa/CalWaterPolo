...
def split_dataset(clip_path):
  ...
  num_train = int(0.003 * num_images)
  train_clips = image_files[:num_train]
  return train_clips, num_train
...
def create_tf_record(train_output_filename, proj_dir):
  ...
  for game_name in game_names:
    ...
    for json_file in json_files:
      ...
      train_clips, num_train = split_dataset(clip_path)
...
def main(_):
  ...
  create_tf_record(train_output_name, proj_dir)
